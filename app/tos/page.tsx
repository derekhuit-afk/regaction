    ...
    <div style={{ minHeight:"100vh", background:"#100202", color:"#F0F4FF", fontFamily:"system-ui,sans-serif" }}>
      <nav style={{ borderBottom:"1px solid rgba(255,255,255,0.08)", padding:"20px 32px", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
        <Link href="/" style={{ display:"flex", alignItems:"center", gap:10, textDecoration:"none" }}>
          ...
          <span style={{ fontSize:15, fontWeight:800, color:"#F0F4FF" }}>RegAction</span>
        </Link>
      ...
      <div style={{ maxWidth:760, margin:"0 auto", padding:"64px 32px" }}>
        ...
        {[
          ["1. Acceptance of Terms",
           "By creating an account or accessing RegAction, you agree to these Terms of Service and all applicable laws. If you do not agree, do not use this service. These terms constitute a binding legal agreement between you and Huit.AI, Inc."],
          ["2. Description of Service",
           "RegAction is a subscription-based software platform provided by Huit.AI, Inc. We reserve the right to modify, suspend, or discontinue any aspect of the service at any time with reasonable notice to active subscribers."],
          ...
          ["4. Subscription and Payment",
           "Access to RegAction requires an active paid subscription. Subscriptions are billed monthly or annually in advance. All fees are non-refundable except as required by law. We use Stripe for payment processing — by subscribing, you also agree to Stripe's terms of service."],
          ["5. Cancellation",
          ...
          ["8. Intellectual Property",
           "All content, features, and functionality of RegAction are owned by Huit.AI, Inc. and are protected by copyright, trademark, and other intellectual property laws. You are granted a limited, non-exclusive, non-transferable license to use the service for your internal business purposes."],
          ["9. Disclaimers",
          ...
          <div key={title} style={{ marginBottom:36, paddingBottom:36, borderBottom:"1px solid rgba(255,255,255,0.06)" }}>
            ...
            <p style={{ fontSize:15, color:"#C8D4E8", lineHeight:1.8 }}>{body.replace(/{name}/g, "RegAction")}</p>
          </div>
        ))}
        ...
        <div style={{ marginTop:48, padding:24, background:"rgba(255,255,255,0.04)", borderRadius:10, border:"1px solid rgba(255,255,255,0.08)" }}>
          <p style={{ fontSize:13, color:"#8FA3C0", textAlign:"center", lineHeight:1.7 }}>
            ...
            &nbsp;·&nbsp; <Link href="/" style={{ color:"#EF4444", textDecoration:"none" }}>Back to RegAction</Link>
          </p>
        </div>
      </div>
    </div>

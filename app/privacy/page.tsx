      ...
      <div style={{ maxWidth:760, margin:"0 auto", padding:"64px 32px" }}>
        ...
        {[
          ...
          ["How We Use Your Information",
           "We use your information to: provide, operate, and improve RegAction; process payments and manage subscriptions; send service-related communications (receipts, security alerts, product updates); respond to support requests; and comply with legal obligations. We do not use your data for advertising."],
          ["Data Sharing",
          ...
          ["Children's Privacy",
           "RegAction is not directed to individuals under 18 years of age. We do not knowingly collect personal information from minors. If we learn that we have collected personal information from a minor, we will delete it promptly."],

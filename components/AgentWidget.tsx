...
const WELCOME = "Hi! I'm the RegAction AI Revenue Agent. I can help you find the right plan, answer questions, or walk you through what we do. What brings you here today?";
  ...
  return (
    <>
      ...
      {open && (
        <div style={{
          ...
          <div style={{
            ...
            <div>
              <div style={{fontSize:14,fontWeight:700,color:"#F0F4FF"}}>RegAction AI Agent</div>
      ...
      <button
        ...
        title="Chat with RegAction AI Agent"
      >
        {open ? "×" : "💬"}
        {!open && unread > 0 && (
          <div style={{
